...
- **[Presentation Report](docs/Project_Report.pdf)**: An IEEE-style Conferrence Paper Project Report.
...
│   └── Project_Report.pdf     # IEEE-style Conferrence Paper Project Report
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/RMO291001/ecg-heartbeat-classification.git
...
Department of Electrical and Computer Engineering<br>RUET<br>Rajshahi, Bangladesh
